...
//         packageList.addPackage(new WinGetPackageFX("TestPackage1", "TestID1", "1.0", "TestSource1"));
//         packageList.addPackage(new WinGetPackageFX("TestPackage2", "TestID2", "2.0", "TestSource2"));
